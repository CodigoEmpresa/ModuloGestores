...
@section('script')
    ...
    <script src="{{ asset('public/Js/Actividad/reporte5.js?n=1') }}"></script>
...
@section('content') 
    <div class="content" id="reporte" class="row" data-url="Reporte">
        <br>
          <h3 id="navbar">Reporte de Calificación de las Ejecuciones</h3>
        <br><br>
		<div class="panel panel-primary">
			    <div class="panel-heading">
			    		<h3 class="panel-title">BUSCADOR: buscador para el reporte de datos de la calificación de las ejecuciones.</h3>
			    </div>
			    <div class="panel-body">
					<fieldset>
						<form action="" id="form_reporte5">
	            	...
	            	<table id="ejecucionesTabla" class="display nowrap" cellspacing="0" width="100%">
	                    <thead>
	                        <tr>
	                            ...
	                            <th><center>MANEJO DEL TEMA</center></th>
	                            <th><center>MATERIAL UTILIZADO</center></th>
	                            <th><center>CONOCIMIENTO ADQUIRIDO</center></th>
	                            <th><center>NOMBRE DEL CALIFICADOR</center></th>
	                            <th><center>TELEFONO DEL CALIFICADOR</center></th>
	                        </tr>
	                    </thead>
	                    <tbody>
	                    </tbody> 
